...
package net.nightingalecare.canarymountains.Pedometer;
...
public class PedometerActivityBackup extends Activity {
...
*/
    ...
    private void startStepService() {
        if (! mIsRunning) {
            ...
            mIsRunning = true;
            startService(new Intent(PedometerActivityBackup.this,
                    StepService.class));
        }
    }
    ...
    private void bindStepService() {
        ...
        bindService(new Intent(PedometerActivityBackup.this,
    ...
    private void stopStepService() {
        ...
        if (mService != null) {
            ...
            stopService(new Intent(PedometerActivityBackup.this,
                  StepService.class));
        }
        mIsRunning = false;
    }
