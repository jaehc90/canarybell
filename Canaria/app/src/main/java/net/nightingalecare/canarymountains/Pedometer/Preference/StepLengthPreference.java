...
package net.nightingalecare.canarymountains.Pedometer.Preference;

import android.content.Context;
import android.util.AttributeSet;

import net.nightingalecare.canarymountains.Pedometer.Preference.EditMeasurementPreference;

import net.nightingalecare.canarymountains.R;

/**
 * An {@link android.preference.EditTextPreference} that only allows float values.
 * @author Levente Bagi
 */
